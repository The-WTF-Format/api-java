 ...
 * - MAPPED_COMPRESSION: Only CLUT-based compression is applied.
 * - COMBINED_COMPRESSION: Both CLUT and reference-based compression techniques are applied.
 * <p>
...
public enum DataCompressionType {
    ...
    private final boolean useClut;

    DataCompressionType(boolean useHuffman, boolean useClut) {
        this.useHuffman = useHuffman;
        this.useClut = useClut;
    }

    /**
     * Indicates whether CLUT-based compression is enabled for this data compression type.
     *
     * @return true if CLUT-based compression is enabled, false otherwise
     */
    public boolean useClut() {
        return useHuffman;
    }
